...
export default async function Dashboard() {
  ...
  const articles = ((data || []) as Article[]).sort((a, b) => new Date(b.modified_at || b.published_at || b.created_at).getTime() - new Date(a.modified_at || a.published_at || a.created_at).getTime())
