...
export default async function Home({ searchParams }: Props) {
  ...
  return <main>
    ...
    <section id="directions" className="page-shell section-block directions-section" aria-labelledby="directions-title">
      <div className="section-heading-simple"><Layers3 aria-hidden="true"/><h2 id="directions-title" className="section-title">Направления</h2></div>
    ...
    <div className="page-shell home-feed-grid">
      <section id="fresh" className="section-block home-feed-main" aria-labelledby="fresh-title">
        <div className="section-heading-simple"><Clock3 aria-hidden="true"/><h2 id="fresh-title" className="section-title">Свежее</h2></div>
      ...
      <aside id="popular" className="section-block popular-section" aria-labelledby="popular-title">
        <div className="section-heading-simple"><BarChart3 aria-hidden="true"/><h2 id="popular-title" className="section-title">Популярное</h2></div>
    ...
    <section className="page-shell blog-cta">
      <div><h2>Нужна помощь с учёбой?</h2><p>Подберите репетитора под свою цель на основном сайте.</p></div>
